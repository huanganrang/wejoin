...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/diveAreaController/add',
			onSubmit : function() {
			...
			<table class="table table-hover table-condensed">
				...
				<tr>	
					...
					<td>
											...
											<input  name="parentCode" type="text" class="easyui-validatebox span2" data-options="required:true"/>
					</td>							
					<th><%=TdiveArea.ALIAS_COUNTRY_CODE%></th>	
					<td>
					
											<input  name="countryCode" type="text" class="easyui-validatebox span2" data-options="required:true"/>
					</td>							
				</tr>	
			</table>		
		</form>
