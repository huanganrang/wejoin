DrawingBoard.Control.Color = DrawingBoard.Control.extend({
	...
	initTemplate: function() {
		...
		var colorBtn = $('.main .toolbar .color').addClass("drawing-board-control-colors-current").data("color",this.board.color).css("background-color",this.board.color);
		colorBtn.after( $( DrawingBoard.Utils.tpl(tpl, {color: this.board.color, rainbows: rainbows }) ) );
