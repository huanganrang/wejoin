		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				...
				<tr>	
					...
					<td>
					<input class="span2" name="sumary" type="text" class="span2"/>
					</td>							
					<th><%=TdiveStore.ALIAS_SERVER_SCOPE%></th>	
					<td>
					<input class="span2" name="serverScope" type="text" class="span2"/>
					</td>							
				</tr>	
				<tr>	
					<th><%=TdiveStore.ALIAS_AREA%></th>	
					<td>
					<input class="span2" name="area" type="text" class="span2"/>
					</td>							
				...
				<tr>	
					...
					<td>
					<input class="span2" name="addtime" type="text" onclick="WdatePicker({dateFmt:'<%=TdiveStore.FORMAT_ADDTIME%>'})"  maxlength="0" class="" />
					</td>							
				</tr>	
			</table>		
		</form>
