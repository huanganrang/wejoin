				...
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交"
							onclick="javascript:$('#find_bshootSquareTopic_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="find_bshootSquareTopic_result"></div>
			<div>
				结果说明：1、json格式<br /> 2、success:true 成功<br /> 3、obj:数组格式<br /> id 主键 <br />
				bss_name 标题 <br /> bss_description 描述 <br /> bss_icon icon图标路径<br />
				bss_userId 广场所有者 <br /> create_datetime 创建时间 <br /> update_datetime
				修改时间 <br /> create_person 创建人 <br /> update_person 修改人 <br />
