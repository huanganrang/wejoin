...
<%
String url = request.getContextPath()+"/api/apiTravelController/featurelist";
%>
...
<body>
	...
	$(function() {
		...
		$('#travel_feature_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#travel_feature_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="travel_feature_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#travel_feature_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：潜水旅游特征结果集，查看基础数据接口</label>
			<div id="travel_feature_result"></div>
			<div>
