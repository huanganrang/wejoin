			...
			<form id="user_myattreduser_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						...
						<td><input name="sort" type="text" class="span2" value="attentionDatetime"/></td>
					</tr>
					...
					<tr>
						...
						<input type="button"
							value="提交" onclick="javascript:$('#user_myattreduser_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
				<div id="user_myattreduser_result">
				</div>
			<div>
				结果说明：1、json格式<br/>
