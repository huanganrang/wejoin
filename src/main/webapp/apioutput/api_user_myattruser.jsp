...
<body>
	...
	$(function() {
		...
		$('#user_myattruser_Form').form({
			url : '${pageContext.request.contextPath}/api/apiUserController/user_myattruser',
			onSubmit : function() {
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#user_myattruser_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="user_myattruser_Form" action="">
				<table align="center" width="90%" class="tablex">
					<tr>
						<td align="right" style="width: 80px;"><label>url：</label></td>
						<td>${pageContext.request.contextPath}/api/apiUserController/user_myattruser</td>
					</tr>
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交"
							onclick="javascript:$('#user_myattruser_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="user_myattruser_result"></div>
			<div>
