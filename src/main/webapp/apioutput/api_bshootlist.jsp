...
<script type="text/javascript">
	$(function() {
		...
		$('#bshootlist_Form').form({
			url : '${pageContext.request.contextPath}/api/bshootController/dataGrid',
			onSubmit : function() {
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="bshootlist_Form" action="">
				<table align="center" width="90%" class="tablex">
					<tr>
						<td align="right" style="width: 80px;"><label>url：</label></td>
						<td>${pageContext.request.contextPath}/api/bshootController/dataGrid</td>
					</tr>
					
					<tr>
						<td align="right" style="width: 180px;"><label>bsTitle(标题)：</label></td>
						<td><input name="bsTitle" type="text" class="span2" value=""/></td>
					</tr>
					<tr>
						<td align="right" style="width: 180px;"><label>bsTopic(分类)：</label></td>
						<td><input name="bsTopic" type="text" class="span2" value=""/></td>
					</tr>
					<tr>
						<td align="right" style="width: 180px;"><label>userId(用户ID)：</label></td>
					...
					<tr>
						...
						<td><input name="sort" type="text" class="span2" value="createDatetime"/></td>
					</tr>
					...
					<tr>
						...
						<input type="button"
							value="提交" onclick="javascript:$('#bshootlist_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
				<div id="bshootlist_result">
				</div>
			<div>
				结果说明：1、json格式<br/>
