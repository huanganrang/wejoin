...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/diveOrderController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
											<input class="span2" name="accountId" type="text"/>
					</td>							
				...
				<tr>	
					...
					<td>
											<input class="span2" name="expressName" type="text"/>
					</td>							
					<th><%=TdiveOrder.ALIAS_EXPRESS_NO%></th>	
					<td>
											<input class="span2" name="expressNo" type="text"/>
					</td>							
				</tr>	
				<tr>	
					<th><%=TdiveOrder.ALIAS_PAY_WAY%></th>	
					<td>
											<input class="span2" name="payWay" type="text"/>
					</td>							
				...
				<tr>	
					...
					<td>
					<input class="span2" name="paytime" type="text" onclick="WdatePicker({dateFmt:'<%=TdiveOrder.FORMAT_PAYTIME%>'})"  maxlength="0" class="" />
					</td>							
				</tr>	
				<tr>	
					<th><%=TdiveOrder.ALIAS_ADDTIME%></th>	
					<td>
					<input class="span2" name="addtime" type="text" onclick="WdatePicker({dateFmt:'<%=TdiveOrder.FORMAT_ADDTIME%>'})"  maxlength="0" class="" />
					</td>							
				</tr>	
			</table>		
		</form>
