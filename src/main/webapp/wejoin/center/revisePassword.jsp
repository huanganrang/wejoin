      ...
      <div class="list_txt">
      		<div class="data" style="padding-top:20px; ">
                <div class="data_list">
                	<ul>
                   	  <form action="" method="get">
                    	<li><span>新密码：</span><input name="" type="text" class="pt_5"/></li>
                        <li><span>确认新密码：</span><input name="" type="text" class="pt_5"/></li>
                        <li><span>手机验证：</span><ol>${sessionScope.userToken.mobile}</ol> <a href="#">发送验证码</a></li>
                        <li><span>验证码：</span><input name="" type="text" class="pt_5" style="width:106px;"/></li>
                        <input name="" type="submit" class="data_an" value="确认提交"/>
                        </form>
                    </ul>
                </div>
            </div>
