...
<div class="list_main">
  ...
  <div class="list_right">
      ...
      <div class="list_txt">
      		<div class="data">
            	<div class="data_img">
           	    	<img src="images/txpic.gif" width="200" height="200" />
                    <a href="#">更改头像</a>
                </div>
                <div class="data_list">
                	<ul>
                   	  <form action="" method="get">
                    	<li><span>昵称：</span><input name="" type="text" class="pt_5"/></li>
                        <li><span>绑定手机：</span><input name="" type="text" class="pt_5"/> <a href="#">发送验证码</a></li>
