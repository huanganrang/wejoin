...
<c:if
	test="${fn:contains(sessionInfo.resourceList, '/diveAddressController/editPage')}">
	<script type="text/javascript">
		$.canEdit = true;
	</script>
</c:if>
<c:if
	test="${fn:contains(sessionInfo.resourceList, '/diveAddressController/delete')}">
	<script type="text/javascript">
		$.canDelete = true;
	</script>
</c:if>
<c:if
	test="${fn:contains(sessionInfo.resourceList, '/diveAddressController/view')}">
	<script type="text/javascript">
		$.canView = true;
	</script>
</c:if>
...
<body>
	...
	<div id="toolbar" style="display: none;">
		<c:if
			test="${fn:contains(sessionInfo.resourceList, '/diveAddressController/addPage')}">
		...
		<c:if
			test="${fn:contains(sessionInfo.resourceList, '/diveAddressController/download')}">
			<a href="javascript:void(0);" class="easyui-linkbutton"
