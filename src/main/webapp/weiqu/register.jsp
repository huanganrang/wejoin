  ...
  <div class="ct-center">
    ...
    <form action="" method="get">
      <ul>
        ...
        <li class="bjno"><em>密码</em><input type="password" class="p1" onBlur="if(this.value==''){this.value='请输入至少六位数的密码';this.style.color='#ccc'}" onFocus="if(this.value=='请输入至少六位数的密码'){this.value='';this.style.color='#333'}" value="请输入至少六位数的密码" name="password" id="password" style="color:#ccc;"></li>
